...
import { Box, Button, Checkbox, FormControlLabel, Link, TextField, Typography, Snackbar, Alert } from "@mui/material";
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Box display='flex' flexDirection='row' alignItems='center'>
              <FormControlLabel
                ...
                label={<Typography variant='body2'>{label.rememberMe}</Typography>}
              />
            </Box>
            <Box>
              <Link onClick={() => router.push("reset-password")} underline='none' sx={{ cursor: "pointer" }}>
