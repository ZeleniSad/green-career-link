...
const labels = {
  ...
  text: `Create an account and become part of the</br>
            ...
            community!`,
  subtitle: "Create an account and become part of the Green Career Link community!",
  description:
    ...
    <Grid
      ...
      <Grid size={5}>
        <Grid container sx={{ gap: 4, p: 3 }}>
          <Typography variant='h1' fontWeight={800} color='white' dangerouslySetInnerHTML={{ __html: labels.text }} />
      ...
      <Grid size={7}>
        <Image src='/images/overview_laptop_mockup.png' alt='Green' width={1274} height={0} layout='intrinsic' />
      </Grid>
    </Grid>
  );
};
